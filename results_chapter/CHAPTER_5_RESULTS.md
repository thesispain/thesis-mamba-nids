...
**Table 5.10: Inference Latency and Throughput**

| Model | Params | Batch 1 (ms/flow) ↓ | Batch 64 (ms/flow) ↓ | Batch 256 (ms/flow) ↓ | Throughput @256 ↑ |
|-------|-------:|---------------------:|----------------------:|----------------------:|------------------:|
| BERT Teacher | 4.59M | 0.530 | 0.019 | 0.017 | 60,602 |
| BiMamba Teacher | 3.66M | 11.252 | 0.183 | 0.124 | 8,046 |
| UniMamba TED @8 | 1.95M | 1.924 | 0.031 | **0.015** | **67,626** |
| UniMamba TED @16 | 1.95M | 3.151 | 0.051 | 0.030 | 33,850 |
| UniMamba TED @32 | 1.95M | 6.019 | 0.096 | 0.063 | 15,993 |

**Analysis:**
- **BiMamba is the slowest** despite O(n) complexity: its bidirectional sequential scan has poor GPU parallelism at n = 32.
- **BERT is fast at batch inference** (60,602 flows/sec @256) because self-attention on 32 tokens is efficiently parallelized.
- **TED @8 is the fastest** (67,626 flows/sec @256) — it processes only 8 packets through a unidirectional scan, combining Mamba's simplicity with early termination.
- TED @8 achieves **1.12× the throughput of BERT** and **8.4× the throughput of BiMamba**.
...
Using the dataset's mean IAT ($\overline{\Delta t}$ = 8.7 ms from UNSW-NB15):

**Table 5.11: Time-to-Detection Comparison**

| Model | Packets Required | Collection Time | Inference Time | Total TTD ↓ | TTD Reduction |
|-------|:----------------:|:---------------:|:--------------:|:-----------:|:-------------:|
| XGBoost / RF | 32 | 278 ms | < 0.1 ms | 278 ms | — |
| BERT Teacher | 32 | 278 ms | 0.017 ms | 278 ms | 0% |
| BiMamba Teacher | 32 | 278 ms | 0.124 ms | 278 ms | 0% |
| UniMamba TED @32 | 32 | 278 ms | 0.063 ms | 278 ms | 0% |
| **UniMamba TED (dynamic)** | **9.0 avg** | **78 ms** | **0.015 ms** | **78 ms** | **72%** |

TED's early exit reduces time-to-detection from 278 ms to **78 ms** — a **3.6× speedup**.
...
> **Key Finding 6:** TED achieves the highest batch throughput (67,626 flows/sec, 1.12× BERT) with 57.6% fewer parameters and reduces time-to-detection from 278 ms to 78 ms (3.6× faster) by classifying 95.7% of flows at 8 packets.
